...
from mmcv.cnn import (DepthwiseSeparableConvModule, ConvModule, bias_init_with_prob, constant_init, is_norm,
                      normal_init)
...
class MJODNetHead(AnchorHead):
    """MJODNetHead modified by YOLOFHead
    ...
    def __init__(self,
        ...
        super(MJODNetHead, self).__init__(num_classes, in_channels, **kwargs)
